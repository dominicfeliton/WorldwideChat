...
public class OllamaSettingsConvos {
    ...
    public static class Url extends StringInputPrompt {
        ...
        public InputResult acceptInput(@NotNull InputContext context, String input) {
            return invMan.genericConfigInput(!input.equals("0"), context, "wwcConfigConversationOllamaURLSuccess",
    ...
    public static class Model extends StringInputPrompt {
        ...
        @Override
        public InputResult acceptInput(@NotNull InputContext context, String input) {
            return invMan.genericConfigInput(!input.equals("0"), context, "wwcConfigConversationOllamaModelSuccess",
