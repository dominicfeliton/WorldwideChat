...
public class GeneralSettingsLangConversation extends StringPrompt {
	...
	public Prompt acceptInput(ConversationContext context, String input) {
		if (!CommonDefinitions.getSupportedTranslatorLang(input).getLangCode().equals("") || input.equals("0")) {
			return CommonDefinitions.genericConfigConversation(!input.equals("0"), context, "wwcConfigConversationlangSuccess", "General.pluginLang", input, TAGS.GEN_SET.smartInv);
		}
