...
public class GeneralSettingsUpdateCheckerConversation extends NumericPrompt {
	...
	public String getPromptText(ConversationContext context) {
		...
		return ChatColor.AQUA + main.getConfigManager().getMessagesConfig()
				.getString("Messages.wwcConfigConversationUpdateCheckerInput")
				.replace("%i", "" + main.getUpdateCheckerDelay());
	}
				...
				final TextComponent successfulChange = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text()
								.content(main.getConfigManager().getMessagesConfig()
										.getString("Messages.wwcConfigConversationUpdateCheckerSuccess"))
