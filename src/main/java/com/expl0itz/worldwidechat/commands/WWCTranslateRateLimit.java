	...
	public boolean processCommand() { /* Init vars */
		...
		if (args.length == 0) {
			if (main.getActiveTranslator(((Player) sender).getUniqueId().toString()) != null) {
					...
					final TextComponent rateLimitAlreadyOff = Component.text()
							...
							.append(Component.text()
									.content(main.getConfigManager().getMessagesConfig()
											.getString("Messages.wwctrlRateLimitAlreadyOffSender"))
				...
				final TextComponent rateLimitOff = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text()
								.content(main.getConfigManager().getMessagesConfig()
										.getString("Messages.wwctrlRateLimitOffSender"))
				...
				final TextComponent notAPlayer = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text().content(
								main.getConfigManager().getMessagesConfig().getString("Messages.wwctrlNotATranslator"))
								.color(NamedTextColor.RED))
						.build();
		...
		if (args.length == 1 && args[0].matches("[0-9]+")) {
			if (main.getActiveTranslator(((Player) sender).getUniqueId().toString()) != null) {
				...
				final TextComponent rateLimitSet = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text()
								.content(main.getConfigManager().getMessagesConfig()
										.getString("Messages.wwctrlRateLimitSetSender").replace("%i", args[0]))
								.color(NamedTextColor.LIGHT_PURPLE))
						.build();
		...
		if (args.length == 1 && args[0] instanceof String) {
			if (Bukkit.getPlayer(args[0]) != null
				...
				ActiveTranslator currTranslator = main
						.getActiveTranslator((Bukkit.getPlayer(args[0])).getUniqueId().toString());
				if (currTranslator.getRateLimit() == 0) {
					final TextComponent rateLimitAlreadyOff = Component.text()
							.append(main.getPluginPrefix().asComponent())
							.append(Component.text().content(main.getConfigManager().getMessagesConfig()
									.getString("Messages.wwctrlRateLimitAlreadyOffTarget").replace("%i", args[0]))
									.color(NamedTextColor.YELLOW))
							.build();
					adventureSender.sendMessage(rateLimitAlreadyOff);
					return false;
				...
				final TextComponent rateLimitOff = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text()
								.content(main.getConfigManager().getMessagesConfig()
										.getString("Messages.wwctrlRateLimitOffTarget").replace("%i", args[0]))
								.color(NamedTextColor.LIGHT_PURPLE))
						.build();
				adventureSender.sendMessage(rateLimitOff);
				final TextComponent rateLimitOffReceiver = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text()
								.content(main.getConfigManager().getMessagesConfig()
										.getString("Messages.wwctrlRateLimitOffSender"))
								.color(NamedTextColor.LIGHT_PURPLE))
				...
				final TextComponent notAPlayer = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text()
								.content(main.getConfigManager().getMessagesConfig()
										.getString("Messages.wwctrlPlayerNotFound").replace("%i", args[0]))
								.color(NamedTextColor.RED))
						.build();
				adventureSender.sendMessage(notAPlayer);
				return true;
		...
		if (args.length == 2 && args[0] instanceof String && args[1].matches("[0-9]+")) {
			if (Bukkit.getServer().getPlayer(args[0]) != null
				...
				final TextComponent rateLimitSet = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text()
								.content(main.getConfigManager().getMessagesConfig()
										.getString("Messages.wwctrlRateLimitSetTarget").replace("%i", args[0])
										.replace("%o", args[1] + ""))
								.color(NamedTextColor.LIGHT_PURPLE))
						.build();
				adventureSender.sendMessage(rateLimitSet);
				final TextComponent rateLimitSetReceiver = Component.text().append(main.getPluginPrefix().asComponent())
						.append(Component.text()
								.content(main.getConfigManager().getMessagesConfig()
										.getString("Messages.wwctrlRateLimitSetSender").replace("%i", args[1]))
								.color(NamedTextColor.LIGHT_PURPLE))
						.build();
