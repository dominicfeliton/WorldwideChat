...
public class TestTranslationUtils {
	...
	public void testTranslationFunctionTarget() {
		...
		assertTrue(CommonDefinitions.translateText("How many diamonds do you have?", playerMock)
	...
	public void testTranslationFunctionSourceTargetOther() {
		...
		assertTrue(
				CommonDefinitions.translateText("Hello, how are you?", secondPlayerMock).equals("Hola, como estas?"));
	}

	public void testTranslationFunctionTargetOther() {
		playerMock.performCommand("worldwidechat:wwct player2 es");
		assertTrue(CommonDefinitions.translateText("How many diamonds do you have?", secondPlayerMock)
				.equals("Cuantos diamantes tienes?"));
	}
